//This OpenSCAD code creates an Engduino stand that looks like a StarWars spaceship
...
module body(){
    //Using polyhderon to specify points and faces for a complex shape
    //Points order matters when specifying faces and teh count starts from 0
    polyhedron( 
        points = [ 
...
//Support cylinders to be substracted
module support(){
    ...
    //Creating one of the back support cylinders and refleccting it
    translate([40, 30, -25])
        cylinder(SUPPORT_CYLINDER_H, SUPPORT_CYLINDER_R, SUPPORT_CYLINDER_R);
...
module stand(){
    ...
    color("DarkSlateGray"){
        ...
        //Extract the support cylinders from the mirrored shape of the body
        difference(){
...
//Calling the stand module starts our program and create the stand
stand();